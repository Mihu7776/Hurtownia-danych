-- SQL Server ETL from the restored backup.
-- This mirrors the stored procedures that already exist in S_Codex.

USE S_Codex;
GO

-- Full ETL orchestration from the restored database:
EXEC dbo.ETL;
GO

-- The most important ETL step is the grouped load into factDrug:
