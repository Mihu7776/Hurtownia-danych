-- Source metadata for SQL Server runtime database S_Codex.
...
-- Public API extraction performed by scripts/load_open_sources.py:
-- NDC: https://api.fda.gov/drug/ndc.json?limit=1000
-- Event: https://api.fda.gov/drug/event.json?search=receivedate:[20240101 TO 20261231]&limit=100&skip=...
